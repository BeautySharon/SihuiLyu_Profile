...
export default function IntroHome({ onSectionClick, contactRef }) {
  ...
  return (
    ...
    >
      <motion.div
        className="mt-10 flex flex-col items-center justify-center bg-white p-10 rounded-xl shadow-lg max-w-[900px] w-full mx-auto hover:-translate-y-1 transition-transform duration-300"
        variants={fadeIn}
      >
